...
const Experience = () => {
  return <section className='mb-12 lg:mb-24 lg:mt-6'>
    <div className="container mx-auto">
      <div className='flex flex-col min-h-[480px] lg:space-x-20 lg:flex-row'>
        <div className='flex-1 flex space-x-6 items-center lg:space-x-12'>
          ...
          <div className='self-end' data-aos='fade-up' data-aos-offset=''>
            <img src={Img2} alt="" />
          </div>
        </div>
        ...
        <div className='flex-1 flex flex-col items-start justify-center mt-6 lg:mt-0' data-aos='fade-left' data-aos-offset='400'>
          ...
          <p className='font-secondary mb-6'>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Doloribus iste nostrum dignissimos expedita totam, optio quaerat culpa nisi sint at.</p>
